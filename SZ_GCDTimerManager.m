#import "SZ_GCDTimerManager.h"

@interface SZ_GCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation SZ_GCDTimerManager

#pragma mark - Public Method

+ (SZ_GCDTimerManager *)sharedInstance {
    static SZ_GCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[SZ_GCDTimerManager alloc] init];
    });
